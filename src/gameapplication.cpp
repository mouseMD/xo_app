...
GAME_INDEX GameApplication::createNewGame() { return manager_.createNewGame(); }

void GameApplication::setNewMove(GAME_INDEX index, Player player,
...
std::string GameApplication::getBoard(GAME_INDEX index) const
{
  ...
  std::string result;
  std::copy(std::cbegin(arrayBoard), std::cend(arrayBoard),
